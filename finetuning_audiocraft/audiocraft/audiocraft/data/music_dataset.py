...
class MusicDataset(InfoAudioDataset):
    ...
    def __init__(self, *args, info_fields_required: bool = True,
        ...
        logger.info(f"info_fields_required: {self.info_fields_required}")
    ...
    def __getitem__(self, index):
        ...
        logger.info(f"[DEBUG] Using self_wav: {music_info.self_wav.path}")
        # print(f"[DEBUG] Using self_wav: {music_info.self_wav.path}")
